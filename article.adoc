...
On the Client host we'll execute the client profile, supplying instructions to use get operation, ??? threads (simulate ??? clients), over a time of 8 hours (60 x 60 x 8 = 28800 seconds).
